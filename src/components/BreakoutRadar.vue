    ...
    <div class="radar-container">
      ...
      <div class="radar-header">
        <div class="radar-header-left">
          ...
          <h1 class="radar-title">
            <span class="gradient-text">Breakout 52W ATH</span> & Pyramiding Radar
          </h1>
          <p class="radar-subtitle">
            Hệ thống tự động theo dõi phá đỉnh 52 tuần, vào lệnh ảo $1,000, nhồi lệnh giảm dần (2/3) khi lãi & dời Stop-Loss bảo toàn vốn.
          </p>
        </div>
      ...
      <div class="metrics-grid">
        <div class="metric-card">
          ...
          <div class="metric-info">
            <span class="metric-label">Mã Theo Dõi ATH</span>
      ...
      <div class="radar-tabs-nav">
        <div class="tabs-group">
          ...
          <button 
            ...
            <span class="tab-icon">🎯</span>
            <span>Watchlist & Giá ATH 52W</span>
      ...
      <div v-else-if="activeTab === 'positions'" class="tab-content">
        <div v-if="filteredOpenPositions.length === 0" class="empty-card">
          ...
          <p>Hệ thống tự động kích hoạt mua ảo $1000 ngay khi giá tài sản trong Watchlist vượt qua mức ATH 52 tuần.</p>
          ...
          <table class="radar-table">
            <thead>
              <tr>
                ...
                <th>Thị Trường</th>
                <th>Giá ATH 52W (Kích Hoạt)</th>
                <th>Giá Hiện Tại</th>
                <th>Khoảng Cách ATH</th>
      ...
      <div class="modal-card">
        ...
        <form @submit.prevent="saveWatchlistItem" class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group flex-1">
              <label>Giá ATH 52 Tuần <span class="text-red">*</span></label>
              <input v-model.number="editingItem.ath_price" type="number" step="any" placeholder="Giá đỉnh 52 tuần..." required class="custom-input font-bold text-gold" />
            </div>
          </div>
