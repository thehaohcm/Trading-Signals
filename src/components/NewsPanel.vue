<template>
  <div class="news-panel" v-if="isVisible">
    <div class="news-panel-header bg-light border-bottom p-3 d-flex justify-content-between align-items-center">
      ...
      <div>
        <button class="btn btn-light btn-sm rounded-circle p-2 me-2" @click="refreshData" title="Refresh">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width: 20px; height: 20px; display: block;">
        ...
        <button class="btn btn-light btn-sm rounded-circle p-2" @click="togglePanel" title="Close">
