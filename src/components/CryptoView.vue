...
.stk-tab--active { color: #fff !important; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%) !important; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3); border-color: rgba(255, 255, 255, 0.1); }
...
/* ---------- HEADER ---------- */
.stk-header { display: flex; align-items: center; gap: 14px; padding: 22px 24px; background: linear-gradient(135deg, #1e293b 0%, #0d0f17 100%); color: #fff; border-bottom: 1px solid rgba(255, 255, 255, 0.06); }
.stk-header__icon { width: 44px; height: 44px; border-radius: 12px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255, 255, 255, 0.1); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
...
.stk-alert-toggle__btn:hover { background: rgba(59,130,246,0.1); border-color: rgba(59,130,246,0.3); color: #60a5fa; }
...
.stk-input:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,0.25); }
...
.stk-row--active { background: rgba(59, 130, 246, 0.12) !important; }
...
.stk-td--symbol { font-weight: 700; color: #60a5fa; text-shadow: 0 0 6px rgba(96, 165, 250, 0.1); }
...
.stk-signal--near_52w_ath { background: rgba(59, 130, 246, 0.12); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.25); }
.stk-signal--near_ath { background: rgba(245, 158, 11, 0.12); color: #fbbf24; border: 1px solid rgba(245, 158, 11, 0.25); }
.stk-signal--ema9_above_ema21 { background: rgba(16, 185, 129, 0.12); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.25); }
...
.stk-spinner { width: 32px; height: 32px; border: 3px solid rgba(255,255,255,0.1); border-top-color: #3b82f6; border-radius: 50%; animation: stk-spin 0.7s linear infinite; }
